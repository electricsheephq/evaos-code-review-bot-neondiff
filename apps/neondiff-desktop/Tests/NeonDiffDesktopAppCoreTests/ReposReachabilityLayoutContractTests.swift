...
@Suite struct ReposReachabilityLayoutContractTests {
    ...
    @Test func settledGeometryBindingsAreFixtureOnlyAndPreserveNativeRegions() throws {
        ...
        #expect(source.contains("SidebarView("))
        #expect(source.contains("selection: $model.selectedSection"))
        #expect(source.contains("readiness: DesktopSetupReadiness(model: model)"))
