...
export function buildReviewPrompt(input: {
  ...
  const promptPrefix = [
    ...
    ...(input.repo === "electricsheephq/lcm-x" ? [
      ...
      "acceptance_evidence must name concrete inspected paths and the observations supporting your verdict. unresolved_findings must preserve every unresolved issue, including issues without an inline diff location."
    ] : []),
    "",
