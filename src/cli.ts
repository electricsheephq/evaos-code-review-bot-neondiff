...
function runInitCommand(args: ParsedArgs): {
  ...
  const requestedConfigPath = parseSingleArg(args.config ?? "config.local.json", "--config").trim();
  if (!requestedConfigPath || requestedConfigPath === "true") {
...
function buildHelp(command?: string) {
  ...
  return {
    ...
    examples: [
      ...
      "npx tsx src/cli.ts eval-sticky-vs-cold --input /path/to/sticky-vs-cold.json --output-root \"${NEONDIFF_EVAL_ROOT:?NEONDIFF_EVAL_ROOT is required}/$(date +%F)/sticky-vs-cold\"",
      "npx tsx src/cli.ts eval-repo-wiki-context-ab --input /path/to/repo-wiki-ab.json --output-root \"${NEONDIFF_EVAL_ROOT:?NEONDIFF_EVAL_ROOT is required}/$(date +%F)/eval-gates/ab\"",
      "npx tsx src/cli.ts eval-openwiki-docs-drift --input /path/to/docs-drift.json --output-root \"${NEONDIFF_EVAL_ROOT:?NEONDIFF_EVAL_ROOT is required}/$(date +%F)/eval-gates/docs-drift\"",
      "npx tsx src/cli.ts review-bench verify-sources --corpus /path/to/corpus.json --artifacts /path/to/source-artifacts --receipt \"${NEONDIFF_EVAL_ROOT:?NEONDIFF_EVAL_ROOT is required}/neondiff-local-review-bench/source-admission.json\"",
      "npx tsx src/cli.ts review-bench prepare-adjudication --candidate /path/to/candidate.json --artifacts /path/to/source-artifacts --output \"${NEONDIFF_EVAL_ROOT:?NEONDIFF_EVAL_ROOT is required}/neondiff-local-review-bench/adjudication-packet\"",
      "npx tsx src/cli.ts review-bench verify-adjudication --packet /path/to/packet.json --primary /path/to/primary.json --secondary /path/to/secondary.json --receipt \"${NEONDIFF_EVAL_ROOT:?NEONDIFF_EVAL_ROOT is required}/neondiff-local-review-bench/adjudication-receipt.json\"",
      "npx tsx src/cli.ts review-bench verify-advisory-adjudication --packet /path/to/packet.json --primary /path/to/agent-a.json --secondary /path/to/agent-b.json --receipt \"${NEONDIFF_EVAL_ROOT:?NEONDIFF_EVAL_ROOT is required}/neondiff-local-review-bench/advisory-receipt.json\"",
      "npx tsx src/cli.ts review-lenses-eval --input-dir tests/fixtures/review-lenses-eval --output-root \"${NEONDIFF_EVAL_ROOT:?NEONDIFF_EVAL_ROOT is required}/$(date +%F)/review-lenses-eval-gate-$(date +%H%M%S)\" --dry-run true",
