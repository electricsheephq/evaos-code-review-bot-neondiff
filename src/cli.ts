...
function buildHelp(command?: string) {
  ...
  return {
    ...
    examples: [
      ...
      "npx tsx src/cli.ts eval-sticky-vs-cold --input /path/to/sticky-vs-cold.json --output-root /path/to/evidence/sticky-vs-cold/$(date +%F)",
      "npx tsx src/cli.ts eval-repo-wiki-context-ab --input /path/to/repo-wiki-ab.json --output-root /path/to/evidence/openwiki-context/$(date +%F)/eval-gates/ab",
      "npx tsx src/cli.ts eval-openwiki-docs-drift --input /path/to/docs-drift.json --output-root /path/to/evidence/openwiki-context/$(date +%F)/eval-gates/docs-drift",
      "npx tsx src/cli.ts review-bench verify-sources --corpus /path/to/corpus.json --artifacts /path/to/source-artifacts --receipt /path/to/evidence/review-bench/source-admission.json",
      "npx tsx src/cli.ts review-bench prepare-adjudication --candidate /path/to/candidate.json --artifacts /path/to/source-artifacts --output /path/to/evidence/review-bench/adjudication-packet",
      "npx tsx src/cli.ts review-bench verify-adjudication --packet /path/to/packet.json --primary /path/to/primary.json --secondary /path/to/secondary.json --receipt /path/to/evidence/review-bench/adjudication-receipt.json",
      "npx tsx src/cli.ts review-bench verify-advisory-adjudication --packet /path/to/packet.json --primary /path/to/agent-a.json --secondary /path/to/agent-b.json --receipt /path/to/evidence/review-bench/advisory-receipt.json",
      "npx tsx src/cli.ts review-lenses-eval --input-dir tests/fixtures/review-lenses-eval --output-root /path/to/evidence/review-lenses/$(date +%F)/review-lenses-eval-gate-$(date +%H%M%S) --dry-run true",
