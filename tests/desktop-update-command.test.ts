...
import { desktopValidatorPath, executeDesktopTransition, planDesktopUpdate, runDesktopUpdateCommand, selectDesktopDeclarationPath } from "../scripts/lib/desktop-update-command.mjs";
