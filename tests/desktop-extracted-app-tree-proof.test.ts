...
`); chmodSync(fakeGh, 0o755);
  ...
  async function transitionAuthorityFixture(action: "update" | "rollback" | "reupdate") {
    ...
    return { action, command, currentPacketPath, env, evidence, head, history, output, previousTargetPacketPath, run, selectedPacket, targetPacketPath, targets, workspace };
  }
