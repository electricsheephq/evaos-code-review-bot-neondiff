...
`); chmodSync(fakeGh, 0o755);
    ...
    return spawnSync(process.execPath, ["scripts/verify-desktop-accepted-evidence-release.mjs", "--artifact", value.artifactPath, "--packet", packetPath, "--bundle", bundlePath, "--release", evidenceRelease, "--tag-ref", evidenceTagRef, "--target-release-tag", packet.tag], { cwd: process.cwd(), encoding: "utf8", env });
  }
