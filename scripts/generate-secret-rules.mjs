...
const swiftCorpusPath = join(root, "apps/neondiff-desktop/Tests/NeonDiffDesktopCoreTests/Support/CanonicalSecretRuleCorpus.generated.swift");
...
const node = `${banner}export interface CanonicalSecretRule { readonly id: string; readonly source: string; readonly ignoreCase: boolean; }\n`+
  ...
  `export const canonicalSecretAlwaysSafeLiterals: readonly string[] = ${JSON.stringify(source.alwaysSafeLiterals, null, 2)};\n`;
...
const swift = `${banner}import Foundation\n\n`+
  ...
  `enum CanonicalSecretAlwaysSafeLiterals {\n    static let generated = [${source.alwaysSafeLiterals.map(swiftString).join(", ")}]\n}\n`;
