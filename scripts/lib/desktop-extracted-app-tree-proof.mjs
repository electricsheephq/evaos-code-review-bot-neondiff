...
required = ("CFBundleIdentifier", "CFBundleShortVersionString", "CFBundleVersion", "SUFeedURL", "SUPublicEDKey")
...
function plistMarkers(bytes) {
  ...
  const bundleID = value.CFBundleIdentifier, version = value.CFBundleShortVersionString, build = value.CFBundleVersion, feedURL = value.SUFeedURL, publicKey = value.SUPublicEDKey;
  ...
  return { appPath: "NeonDiff.app", bundleID, version, build, feedURL, publicKey };
}
