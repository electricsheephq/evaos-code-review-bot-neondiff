...
const KIND = "neondiff.desktop.accepted-release-packet-v2", SHA1 = /^[a-f0-9]{40}$/, MAX_INPUT = 4 * 1024 * 1024;
const FIELDS = ["schemaVersion", "kind", "verified", "channel", "version", "build", "tag", "sourceSHA", "tagObjectSHA", "artifactURL", "artifactName", "artifactByteLength", "artifactSHA256", "treeSHA256", "feedSHA256", "feedEntry", "enclosureProofSHA256", "releaseContract", "productionContract", "npmReleaseClass"];
