...
function metadata(tagRefPath, tagObjectPath, releasePath, declaration) {
  ...
  const prerelease = declaration.channel !== "stable"; if (release?.tag_name !== declaration.tag || release?.draft !== false || release?.prerelease !== prerelease || release?.immutable !== true) fail("immutable product release metadata is required");
